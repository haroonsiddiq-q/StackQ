        ...
        <div className="relative grid grid-cols-3 p-4 size-full">
            ...
            <div className="col-start-1 col-span-2 size-full font-body space-y-3 p-40">
                <div className="space-y-3">
                    <h1 data-cursor-expand className="text-6xl flex gap-3 w-fit">Hey, I'm Haroon <span className="text-primary">S</span> Qureshi.</h1>
            ...
            <a data-cursor-expand className="absolute bottom-70 left-162 p-4 bg-card border-8 border-slash" href="#project">Scroll or Click here to continue</a>
            </div>
        </div>
    );
}