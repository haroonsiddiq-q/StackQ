...
export function About() {
    return (
        <div className="relative grid grid-cols-3 p-4 size-full">
            ...
            <a data-cursor-expand className="absolute bottom-60 left-100 p-4 bg-card border-8 border-slash font-pixel" href="#project">Scroll or Click here to continue</a>
            </div>
        </div>
    );
}